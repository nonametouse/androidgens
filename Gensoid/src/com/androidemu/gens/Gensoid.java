...
import com.androidemu.gens.input.Trackball;

import java.io.File;

public class Gensoid extends Activity implements GameKeyListener,
	...
	private boolean initEmulator() {
		...
		if (!emulator.initialize(libdir, "gens"))
			return false;
	...
	private void loadGlobalSettings() {
		...
		emulator.setOption("sixButtonPad", 
				settings.getBoolean("sixButtonPad", false));
